  ...
  return (
    <div className={`relative ${className}`}>
      <button
        type="button"
        onClick={onToggle}
        className="flex items-center gap-2 h-10 px-3.5 rounded-full bg-card/95 text-foreground shadow-md backdrop-blur-md border border-border hover:bg-secondary transition-colors text-xs font-bold"
      >
        <ReactCountryFlag
          countryCode={countryCode}
          svg
          style={{ width: "1.2em", height: "1.2em", borderRadius: "2px", objectFit: "cover" }}
