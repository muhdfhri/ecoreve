...
export const CleanWaterSection: React.FC = () => {
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 py-8" id="why">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-[#1a2328] text-white p-8 md:p-14 min-h-[500px] flex flex-col justify-between shadow-2xl border border-border/20">
