...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Comprehensive water & wastewater treatment solutions by Qingdao Topolar New Material Co., Ltd." },
      { name: "author", content: "EcoReve" },
      { property: "og:title", content: "Ecoreve - Qingdao Topolar New Material Co.,Ltd" },
      { property: "og:description", content: "Advanced Water Treatment & Environmental Technology." },
