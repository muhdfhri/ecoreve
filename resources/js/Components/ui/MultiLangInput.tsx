...
export const LANG_OPTIONS = [
  ...
  { code: "id", flag: "🇮🇩", label: "ID", name: "Indonesian" },
  { code: "ms", flag: "🇲🇾", label: "MS", name: "Malay" },
  { code: "th", flag: "🇹🇭", label: "TH", name: "Thai" },
  { code: "zh", flag: "🇨🇳", label: "ZH", name: "Chinese" },
] as const;

export type LanguageKey = "en" | "id" | "ms" | "th" | "zh";
  ...
  return (
    <div className="space-y-1.5 font-sans">
      ...
      <input
        ...
        placeholder={placeholder ? `${placeholder} (${activeLangOption.name})` : `Enter text in ${activeLangOption.name}...`}
